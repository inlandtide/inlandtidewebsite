...
- Changed the first home page service tile preview so it uses the normal light tile styling by default and switches to the inverted Saint Louis Navy treatment only on hover.
